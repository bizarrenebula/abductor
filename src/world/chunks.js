...
import { CHUNK, SEG, WATER_Y } from '../core/constants.js';
...
import { animals, pickups, props, shelters } from '../entities/registry.js';
...
export function clearWorld(){
  for(const [k,c] of chunks){scene.remove(c.mesh);c.mesh.geometry.dispose();
    ...
    c.builds.forEach(o=>scene.remove(o));}
  chunks.clear();animals.length=0;pickups.length=0;props.length=0;shelters.length=0;
}
